...
WARPED_CROPPED_IMG_SIZE = (400 - EDGE_CROP_MARGIN*2, 350 - EDGE_CROP_MARGIN*2)
...
class GelsightWedgeVideo():
    ...
    def auto_clip(self, depth_threshold=DEPTH_THRESHOLD, clip_offset=AUTO_CLIP_OFFSET, return_indices=False):
